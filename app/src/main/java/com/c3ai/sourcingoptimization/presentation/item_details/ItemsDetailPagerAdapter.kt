...
import com.c3ai.sourcingoptimization.presentation.item_details.overview.OverviewFragment
...
class ItemsDetailPagerAdapter(fm: FragmentManager) : FragmentStatePagerAdapter(fm) {
    ...
    private val tabFragmentsCreators: Map<Int, () -> Fragment> = mapOf(
        ...
        PO_LINES_PAGE_INDEX to { OverviewFragment() },
        SUPPLIERS_PAGE_INDEX to {OverviewFragment()}
    )
